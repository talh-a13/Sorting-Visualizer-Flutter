...
final List<SortingAlgorithm> sortingAlgorithmsList = [
  SortingAlgorithm(
    ...
    complexity: nsquare,
    resources: [
      Resource('Devolped By Talha Hussian ', 'https://www.geeksforgeeks.org/'),
    ],
  ),
  SortingAlgorithm(
    ...
    complexity: nsquare,
    resources: [
      Resource('Devolped By Talha Hussain ', 'https://www.geeksforgeeks.org/'),
    ],
  ),
  SortingAlgorithm(
    ...
    resources: [
      Resource('Devolped By ', 'https://www.geeksforgeeks.org/'),
    ],
  ),
];
